...
import os
import sys
sys.path.append('/root/DLResearch/coco-caption')
sys.path.append('/root/DLResearch/coco-caption/pycocoevalcap/bleu/')
sys.path.append('/root/DLResearch/coco-caption/pycocoevalcap/cider/')
